...
void testWithBenchMark()
{
    ...
    double w=0, rs=0, rp=0, rsrange = 0, rst=0 ;
    long rscount = 0, rsrangecount = 0, rstcount = 0;
    double durationW=0,durationRS=0,durationRP=0, durationRSRange=0, durationRST=0;;
...
//					}
		...
		if (i%LOG_POINT == 0)
		{
			...
			cout << i/LOG_POINT <<",\t" << (durationW+durationRP+durationRS+durationRSRange)/i <<",\t" << durationW/w  <<",\t" << durationRP/rp <<",\t" << durationRS/rs <<",\t" << rscount/rs <<",\t" << durationRSRange/rsrange <<",\t" << rsrangecount/rsrange<<",\t" << durationRST/rst <<",\t" << rstcount/rst <<endl<<endl;
